...
export const templates: QrTemplate[] = [
  { id: 1, fg: "#111827", bg: "#ffffff", eye: "#111827", shape: "square", eyeShape: "square", variant: "plain" },
  { id: 2, fg: "#111827", bg: "#ffffff", eye: "#111827", shape: "dot", eyeShape: "circle", variant: "plain" },
  { id: 3, fg: "#1d4ed8", bg: "#ffffff", eye: "#1d4ed8", shape: "rounded", eyeShape: "rounded", variant: "plain" },
  { id: 4, fg: "#0f172a", bg: "#ffffff", eye: "#2563eb", shape: "rounded", eyeShape: "circle", variant: "plain" },
  { id: 5, fg: "#7c3aed", bg: "#ffffff", eye: "#7c3aed", shape: "dot", eyeShape: "rounded", variant: "plain" },
  { id: 6, fg: "#059669", bg: "#ffffff", eye: "#065f46", shape: "rounded", eyeShape: "rounded", variant: "plain" },
  { id: 7, fg: "#dc2626", bg: "#ffffff", eye: "#111827", shape: "square", eyeShape: "rounded", variant: "plain" },
  { id: 8, fg: "#0891b2", bg: "#ffffff", eye: "#0f172a", shape: "dot", eyeShape: "circle", variant: "plain" },
  { id: 9, fg: "#ea580c", bg: "#ffffff", eye: "#ea580c", shape: "rounded", eyeShape: "square", variant: "plain" },
  { id: 10, fg: "#111827", bg: "#fef3c7", eye: "#b45309", shape: "square", eyeShape: "square", variant: "plain" },
  { id: 11, fg: "#ffffff", bg: "#111827", eye: "#38bdf8", shape: "rounded", eyeShape: "rounded", variant: "gradient" },
  { id: 12, fg: "#be123c", bg: "#fff1f2", eye: "#be123c", shape: "dot", eyeShape: "circle", variant: "plain" },
  { id: 13, fg: "#1e293b", bg: "#e2e8f0", eye: "#0ea5e9", shape: "rounded", eyeShape: "circle", variant: "plain" },
  { id: 14, fg: "#7c3aed", bg: "#faf5ff", eye: "#a855f7", shape: "diamond", eyeShape: "circle", variant: "plain" },
  { id: 15, fg: "#dc2626", bg: "#fef2f2", eye: "#dc2626", shape: "star", eyeShape: "square", variant: "plain" },
  { id: 16, fg: "#059669", bg: "#ecfdf5", eye: "#10b981", shape: "heart", eyeShape: "rounded", variant: "plain" },
  { id: 17, fg: "#ea580c", bg: "#fff7ed", eye: "#f97316", shape: "triangle", eyeShape: "circle", variant: "plain" },
  { id: 18, fg: "#111827", bg: "#f0fdf4", eye: "#16a34a", shape: "diamond", eyeShape: "square", variant: "plain" },
  { id: 19, fg: "#f43f5e", bg: "#ffffff", eye: "#e11d48", shape: "star", eyeShape: "circle", variant: "plain" },
  { id: 20, fg: "#0284c7", bg: "#f0f9ff", eye: "#0ea5e9", shape: "heart", eyeShape: "square", variant: "plain" },
  { id: 21, fg: "#fbbf24", bg: "#1c1917", eye: "#f59e0b", shape: "rounded", eyeShape: "circle", variant: "gradient" },
  { id: 22, fg: "#8b5cf6", bg: "#ffffff", eye: "#7c3aed", shape: "triangle", eyeShape: "rounded", variant: "plain" },
  { id: 23, fg: "#ec4899", bg: "#fdf2f8", eye: "#db2777", shape: "dot", eyeShape: "circle", variant: "plain" },
  { id: 24, fg: "#14b8a6", bg: "#f0fdfa", eye: "#0d9488", shape: "diamond", eyeShape: "rounded", variant: "plain" },
  { id: 25, fg: "#ffffff", bg: "#0f172a", eye: "#f43f5e", shape: "star", eyeShape: "circle", variant: "gradient" },
  { id: 26, fg: "#1c1917", bg: "#fef9c3", eye: "#a16207", shape: "square", eyeShape: "circle", variant: "plain" },
  { id: 27, fg: "#ffffff", bg: "#7c3aed", eye: "#fbbf24", shape: "heart", eyeShape: "rounded", variant: "gradient" },
  { id: 28, fg: "#f43f5e", bg: "#111827", eye: "#f43f5e", shape: "diamond", eyeShape: "square", variant: "gradient" },
  { id: 29, fg: "#0d9488", bg: "#f0fdfa", eye: "#0d9488", shape: "triangle", eyeShape: "circle", variant: "plain" },
  { id: 30, fg: "#1e293b", bg: "#f1f5f9", eye: "#e11d48", shape: "rounded", eyeShape: "circle", variant: "plain" },
  { id: 31, fg: "#ffffff", bg: "#be185d", eye: "#fbbf24", shape: "star", eyeShape: "circle", variant: "gradient" },
  { id: 32, fg: "#111827", bg: "#ecfdf5", eye: "#059669", shape: "heart", eyeShape: "circle", variant: "plain" },
  { id: 33, fg: "#0f172a", bg: "#e0e7ff", eye: "#4f46e5", shape: "diamond", eyeShape: "rounded", variant: "plain" },
  { id: 34, fg: "#ffffff", bg: "#1e293b", eye: "#22d3ee", shape: "dot", eyeShape: "circle", variant: "gradient" },
];
