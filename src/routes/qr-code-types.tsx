...
export const Route = createFileRoute("/qr-code-types")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://qr.nxtgensec.org/qr-code-types" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
    links: [
      { rel: "canonical", href: "https://qr.nxtgensec.org/qr-code-types" },
      { rel: "alternate", hreflang: "en", href: "https://qr.nxtgensec.org/qr-code-types" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "CollectionPage",
          name: "QR Code Types",
          description: "Every QR Code type you can create for free with UnifiedQR.",
          url: "https://qr.nxtgensec.org/qr-code-types",
        }),
      },
    ],
  }),
...
const details: Record<string, string> = {
  ...
  "multi-url":
    "Link websites, videos and social profiles in a single QR Code — ideal for campaigns that need more than one destination.",
  contact:
    "Share a full vCard with name, phone, email, company and website. One scan saves you to their address book.",
  ...
  email:
    "Open a new email with the recipient, subject and body already filled in for faster support requests.",
  phone:
    "Let people call your business instantly without typing a number — great for signage and business cards.",
