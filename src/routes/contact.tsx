...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://qr.nxtgensec.org/contact" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
    links: [
      { rel: "canonical", href: "https://qr.nxtgensec.org/contact" },
      { rel: "alternate", hreflang: "en", href: "https://qr.nxtgensec.org/contact" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "ContactPage",
          name: "Contact UnifiedQR",
          url: "https://qr.nxtgensec.org/contact",
          mainEntity: {
            "@type": "Organization",
            name: "UnifiedQR",
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
      ...
      <p className="mt-3 text-muted-foreground">
        Questions about plans, dynamic QR Codes or a large campaign? Send us a message or email us
        directly at{" "}
        <a
